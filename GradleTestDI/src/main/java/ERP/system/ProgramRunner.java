...
public class ProgramRunner {
    ...
    public ProgramRunner(Authenticator authenticator, ClientManager clientManager, ConsoleManager consoleManager, ProtocolManager protocolManager, DateParser dateParser) {
